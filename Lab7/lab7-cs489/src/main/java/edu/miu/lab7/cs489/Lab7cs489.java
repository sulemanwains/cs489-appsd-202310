...
import edu.miu.lab7.cs489.service.DentistService;
...
public class Lab7cs489 implements CommandLineRunner {
    private final AppointmentService appointmentService;
    private final DentistService dentistService;
    private final PatientService patientService;

    public Lab7cs489(AppointmentService appointmentService, DentistService dentistService, PatientService patientService) {
    ...
    public static void main(String[] args) {
        SpringApplication.run(Lab7cs489.class, args);
    }
